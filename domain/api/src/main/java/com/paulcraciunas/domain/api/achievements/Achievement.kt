...
enum class Achievement(
    ...
    FAILED_PUZZLES_REDEEMED(5L, 25L, 100L, 250L, 500L),
    FIND_SQUARE_SESSIONS(5L, 25L, 100L, 250L, 500L),
    KNIGHT_PATH_SESSIONS(5L, 25L, 100L, 250L, 500L),
    ...
    KNIGHTS_PATH(5L, 7L, 10L, 15L, 20L),
