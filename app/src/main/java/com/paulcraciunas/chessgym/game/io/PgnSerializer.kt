...
import com.paulcraciunas.chessgym.game.MetaData
...
import com.paulcraciunas.chessgym.game.board.toFile
import com.paulcraciunas.chessgym.game.board.toRank
...
object PgnSerializer : Serializer {
    ...
    override fun from(gameString: String): Game {
        ...
        val remaining = lines.drop(idx).fastJoinToString(separator = " ")
