...
internal val WalnutLightColors = ChessGymColors(
    ...
    boardEdge = Color(0xFF293342),
    boardText = Color(0xFF6880A4),
    boardSquareSelected = Color(0x99999999),
    boardMoveAvailable = Color(0xDD999999),
    boardMovePreviousFrom = Color(0x8D5F9A8E),
    boardMovePreviousTo = Color(0xA8228C76),
