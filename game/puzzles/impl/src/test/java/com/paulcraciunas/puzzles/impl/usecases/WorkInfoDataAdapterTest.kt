...
internal class WorkInfoDataAdapterTest {
    ...
    @Test
    fun `GIVEN null data WHEN adapt is called THEN returns progress with all zeros`() {
        // Given
        val data: Data? = null
    ...
    @Test
    fun `GIVEN empty data WHEN adapt is called THEN returns progress with all zeros`() {
        // Given
    ...
    fun `GIVEN download step with 0 percent WHEN adapt is called THEN returns correct progress`() {
        // Given
        val data = createData("Download", 0)
    ...
    fun `GIVEN download step with 50 percent WHEN adapt is called THEN returns correct progress`() {
        // Given
        val data = createData("Download", 50)
    ...
    fun `GIVEN download step with 100 percent WHEN adapt is called THEN returns correct progress`() {
        // Given
        val data = createData("Download", 100)
    ...
    fun `GIVEN unpack step with 100 percent WHEN adapt is called THEN returns correct progress`() {
        // Given
        val data = createData("Unpack", 100)
    ...
    fun `GIVEN buildDb step with 80 percent WHEN adapt is called THEN returns correct progress`() {
        // Given
        val data = createData("BuildDb", 80)
    ...
    fun `GIVEN buildDb step with 100 percent WHEN adapt is called THEN returns complete progress`() {
        // Given
        val data = createData("BuildDb", 100)
    ...
    fun `GIVEN invalid step string WHEN adapt is called THEN defaults to download`() {
        // Given
        val data = createData("InvalidStep", 50)
    ...
    fun `GIVEN negative progress value WHEN adapt is called THEN defaults to 0`() {
        // Given
        val data = createData("Download", -10)
    ...
    @Test
    fun `GIVEN progress value over 100 WHEN adapt is called THEN uses value as is`() {
        // Given
        val data = createData("Download", 150)
    ...
    fun `GIVEN all valid step values WHEN adapt is called THEN correctly maps each step`() {
        ...
        testCases.forEach { (step, progress, expected) ->
            // Given
            val data = createData(step, progress)
    ...
    fun `GIVEN boundary progress values WHEN adapt is called THEN handles boundaries correctly`() {
        ...
        boundaryValues.forEach { progressValue ->
            // Test Download step
            val downloadData = createData("Download", progressValue)
            ...
            // Test Unpack step
            val unpackData = createData("Unpack", progressValue)
            ...
            // Test BuildDb step
            val buildDbData = createData("BuildDb", progressValue)
    ...
    private fun createData(step: String?, progress: Int): Data {
        val builder = Data.Builder()
        if (step != null) {
            builder.putString(PuzzleSyncWorker.STEP, step)
        }
        builder.putInt(PuzzleSyncWorker.PROGRESS_NAME, progress)
